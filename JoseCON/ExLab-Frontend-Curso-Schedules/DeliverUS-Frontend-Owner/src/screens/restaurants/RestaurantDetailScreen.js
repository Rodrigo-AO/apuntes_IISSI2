      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <MaterialCommunityIcons 
            name='timetable' 
            color={item.schedule ? GlobalStyles.brandGreen : GlobalStyles.brandPrimary} 
            size={20} 
          />
          <TextRegular textStyle={{ color: item.schedule ? GlobalStyles.brandGreen : GlobalStyles.brandPrimary, marginLeft: 5 }}>
